...
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/MoviesGalaxyfilter_bot>✪Gᴀʟᴀxʏ Fɪʟᴛᴇʀ ʙᴏᴛ✪</a>
...
✭ Cᴏɴᴛᴀᴄᴛ ᴛᴏ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ <a href='https://t.me/EK4MPREETSINGH'>Dᴇᴠᴇʟᴏᴘᴇʀ</a></b> """
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/EK4MPREETSINGH)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
my features Stay here new features coming soon...  
 ...
 <b>✯ Join here : <a href=https://t.me/MoviesGalaxy01>☘Mᴏᴠɪᴇs Gᴀʟᴀxʏ☘</a></b> 
...
Tɪᴘ: Sᴇʟᴇᴄᴛ "Lᴀɴɢᴜᴀɢᴇs" ᴏʀ "Sᴇᴀsᴏɴs" Bᴜᴛᴛᴏɴ ᴀɴᴅ Cʟɪᴄᴋ "Sᴇɴᴅ Aʟʟ" Tᴏ ɢᴇᴛ Aʟʟ Fɪʟᴇ Lɪɴᴋs ɪɴ ᴀ Sɪɴɢʟᴇ ᴄʟɪᴄᴋ"""
    ...
    SINFO = """
🫣 Pʟᴇᴀsᴇ ᴄʜᴇᴄᴋ ɪᴛ ᴀɴᴅ ᴀғᴛᴇʀ ᴊᴏɪɴɪɴɢ ᴄʟɪᴄᴋ ᴏɴ ᴛʀʏ ᴀɢᴀɪɴ"""
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """📂Fɪʟᴇɴᴀᴍᴇ : @MoviesGalaxy120 {file_name}
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த ✫Mᴏᴠɪᴇs Gᴀʟᴀxʏ ғɪʟᴛᴇʀ ʙᴏᴛ✫ போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்

 படி 2: உங்கள் இணையதளம் மற்றும் API ஐச் சேர்க்கவும்

 Exp: /shortlink omegalinks.in 4b392f8e11fbe58
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this ✫Mᴏᴠɪᴇs Gᴀʟᴀxʏ ғɪʟᴛᴇʀ ʙᴏᴛ✫ bot to your group

 Step 2: Add your website and API

 Exp: /shortlink omegalinks.in 4b392f8eb6fbe58
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ ✫Mᴏᴠɪᴇs Gᴀʟᴀxʏ ғɪʟᴛᴇʀ ʙᴏᴛ✫ బాట్‌ని మీ సమూహానికి నిర్వహించండి

 దశ 2: మీ వెబ్‌సైట్ మరియు APIని జోడించండి

 గడువు: /shortlink omegalinks.in 4b392f8eb61fbe58
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस ✫Mᴏᴠɪᴇs Gᴀʟᴀxʏ ғɪʟᴛᴇʀ ʙᴏᴛ✫ को अपने समूह में प्रशासित करें

 चरण 2: अपनी वेबसाइट और एपीआई जोड़ें

 एक्सप: /शॉर्टलिंक omegalinks.in 4b392ad711fbe58
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 കാലഹരണപ്പെടൽ: /shortlink omegalinks.in 4b3926ad711fbe58
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس ✫Mᴏᴠɪᴇs Gᴀʟᴀxʏ ғɪʟᴛᴇʀ ʙᴏᴛ✫ بوٹ کا انتظام کریں۔

 مرحلہ 2: اپنی ویب سائٹ اور API شامل کریں۔

 Exp: /shortlink omegalinks.in 4b392fd711fbe58
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ ✫Mᴏᴠɪᴇs Gᴀʟᴀxʏ ғɪʟᴛᴇʀ ʙᴏᴛ✫ બોટનું સંચાલન કરો

 પગલું 2: તમારી વેબસાઇટ અને API ઉમેરો

 સમાપ્તિ: /shortlink omegalinks.in 4b392f8eb61fbe58
...
ಹೇ {message.from_user.mention}
 ...
 ಅವಧಿ: /shortlink omegalinks.in 4b392f8ebe58
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই ✫Mᴏᴠɪᴇs Gᴀʟᴀxʏ ғɪʟᴛᴇʀ ʙᴏᴛ✫ বট পরিচালনা করুন

 ধাপ 2: আপনার ওয়েবসাইট এবং API যোগ করুন

 মেয়াদ: /shortlink omegalinks.in 4b392f711fbe58
